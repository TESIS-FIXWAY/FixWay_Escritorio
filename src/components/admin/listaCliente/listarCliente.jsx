  ...
  const handleDelete = async () => {
    try {
      if (selectedClientId) {
        ...
        setClientes(
          clientes.filter((cliente) => cliente.id !== selectedClientId)
        );
        setClientesFiltrado(
          clientesFiltrado.filter((cliente) => cliente.id !== selectedClientId)
        );
        handleCloseDelete();
      }
    } catch (error) {
    ...
    try {
      ...
      setClientes(
        clientes.map((cliente) =>
          cliente.id === selectedClientData.id ? selectedClientData : cliente
        )
      );
      setClientesFiltrado(
