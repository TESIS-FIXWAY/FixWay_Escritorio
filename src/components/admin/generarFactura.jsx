    ...
    try {
      ...
      for (const producto of productosSeleccionados) {
        ...
        if (typeof producto.cantidad === 'number' && !isNaN(producto.cantidad)) {
          ...
          // Verificar si existingQuantity es un número válido
          if (typeof existingQuantity === 'number' && !isNaN(existingQuantity)) {
            // Verificar si la resta resulta en una cantidad no negativa
            const newQuantity = Math.max(existingQuantity - producto.cantidad, 0);
